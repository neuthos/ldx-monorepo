...
- **No open Questions.** The Q&A-4/5 Options mis-sync introduced by the `r100p3-k83v5n` sync was corrected in `r100p3-5db5bd`; both answers were re-given against the corrected options and materialized in `r100p3-4461a2`.
